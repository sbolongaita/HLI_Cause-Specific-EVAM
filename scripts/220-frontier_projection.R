...
sourceEnv(); tidy()
scriptName <- "220-frontier_projection"

# Loading data
sarahLoad(c("country_info", "frontier_harmonized", "frontier_analysis_info", "population"))
...
sarahSave(c("frontier_projected", "frontier_projection_info"), type = "both")
